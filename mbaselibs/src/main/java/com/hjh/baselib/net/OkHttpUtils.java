...
public class OkHttpUtils {
    ...
    public OkHttpUtils(OkHttpClient okHttpClient)
    {
        if (okHttpClient == null)
        {
            ...
            mOkHttpClient.dispatcher().setMaxRequestsPerHost(20);//修改最大请求数为20
        } else
        {
    ...
    //拼装get参数
    protected String pingGetParams(String url,Map<String, String> params){
    ...
    public Call get(Map<String,String> map,String url,Map<String,String> header){
        url = pingGetParams(url,map);
        Call call;
...
//        return mOkHttpClient.newCall(request);
    ...
    public Call put(Map<String,String> map,String url,Map<String,String> header){
        Call call;
        /**
         * 创建请求的参数body
         */
...
//        return mOkHttpClient.newCall(request);
    ...
    public Call delete(Map<String,String> map,String url,Map<String,String> header){
        Call call;
        /**
         * 创建请求的参数body
         */
...
//        return mOkHttpClient.newCall(request);
    ...
    public Call patch(Map<String,String> map,String url,Map<String,String> header){
        Call call;
        /**
         * 创建请求的参数body
         */
...
//        return mOkHttpClient.newCall(request);
    ...
    public Call postJson(String json,String url,Map<String,String> header){
        Call call;
     ...
     * @return
     */
    public Call postFileFrom(File file,Map<String, String> map, String url,Map<String,String> header){
        Call call;
